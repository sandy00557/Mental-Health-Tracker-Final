...
import { useState } from "react";
import "../assets/animations/PasswordInput.css";
...
const PasswordInput = ({
  ...
  const showValidation =
    password && passwordType1 && !isValidPassword(password);
  ...
  return (
    <div className="password-input-wrapper">
      <input
        ...
        onChange={(e) => finalPassword(e.target.value)}
      />
      ...
      {showMismatch && <p style={{ color: "red" }}>Passwords do not match.</p>}
    </div>
  );
};
export default PasswordInput;
