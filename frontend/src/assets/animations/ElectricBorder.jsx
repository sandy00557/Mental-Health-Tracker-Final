// // ElectricBorder.jsx
// // Reusable wrapper to apply the electric border animation (React Bits style)
...
//       <div className="absolute inset-0 rounded-xl border-[3px] border-transparent animate-electric-border"></div>

//       {/* Inner content */}
//       <div className="relative z-10 rounded-xl bg-white dark:bg-gray-900 p-6">
//         {children}
//       </div>
//     </div>
//   );
